...
var encodedData = require('soop').load('clickcore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('clickcore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('clickcore/lib/Address', {
